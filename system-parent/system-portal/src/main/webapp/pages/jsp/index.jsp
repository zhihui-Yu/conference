...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/pages/static/layui/css/layui.css" media="all">
        <link rel="stylesheet" type="text/css" href="/pages/static/css/login.css"/>
        <script src="/pages/static/layui/layui.js" charset="utf-8"></script>
        <script src="/pages/static/js/jquery-3.2.1.min.js" charset="utf-8"></script>
    </head>
    <body>
    <div class="logindiv">
